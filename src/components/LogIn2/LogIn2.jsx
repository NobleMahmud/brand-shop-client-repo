                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                        <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                            ...
                            <p className="mt-2 text-base text-gray-600">Don’t have an account? <Link to="/register2" className="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Create a free account</Link></p>
